...
const Resume = () => {
  return (
    ...
    <div class="stops">
      ...
      <div class="thumbnails">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSaP2WTTlLw-A8nQEw2g_JxPHVNh3XCo1Oc0A&s" alt=""/>
        <img src="https://www.lpu.in/authenticate/lpu%20logo.png" alt=""/>
      </div>
    </div>
  </div>
  ...
  <div class="travel-card" data-aos="fade-up-right">
    ...
    <div class="stops">
      ...
      <div class="thumbnails">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSKHpMBf-fSuqn6moTO4vwYBNRiiikbrh5RKg&s" alt=""/>
        <img src="https://content.jdmagicbox.com/comp/lucknow/u4/0522px522.x522.220921235652.f3u4/catalogue/rani-laxmi-bai-memorial-school-indira-nagar-sector-14-lucknow-private-schools-B3qZAlPQir.jpg" alt=""/>
      </div>
    </div>
  </div>
  ...
  <div class="travel-card" data-aos="fade-up-right">
    ...
    <div class="content">
      <h3>Associate Research Analyst <span>↗</span></h3>
    ...
    <div class="content">
      <h3>Associate Analyst <span>↗</span></h3>
    ...
    <div class="content">
      <h3>Associate Software Developer <span>↗</span></h3>
